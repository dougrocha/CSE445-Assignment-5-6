<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DougWebService.aspx.cs" Inherits="WebApplication.TryIt.DougWebService" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <h1>Doug's Web Service Test Page</h1>
        <p>Test Encryption, Decryption, and Hashing Service</p>
        <p>NOTE: This is primarily for testing the web service. This is a similar page to the DLL Test but through a web service connection.</p>
    </div>
    <div>
    ...
    <div>
        ...
        <asp:TextBox ID="txtEncryptInput" runat="server" Width="400px" TextMode="MultiLine" Rows="4" Placeholder="Enter text to encrypt"></asp:TextBox>
        <br />
    ...
    <div>
        ...
        <asp:TextBox ID="txtDecryptInput" runat="server" Width="400px" TextMode="MultiLine" Rows="4" Placeholder="Enter text to decrypt"></asp:TextBox>
        <br />
    ...
    <div>
        <h2>Hashing Test</h2>
        <asp:TextBox ID="txtHashInput" runat="server" Width="400px" TextMode="SingleLine" Placeholder="Enter password to hash"></asp:TextBox>
        <br />
